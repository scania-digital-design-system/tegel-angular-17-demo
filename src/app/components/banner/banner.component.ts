...
export class BannerComponent {
  ...
  defaultBannerRef: ElementRef<HTMLTdsBannerElement>;
  @ViewChild("errorBanner", { static: true })
  errorBanner: ElementRef<HTMLTdsBannerElement>;
  @ViewChild("informationBanner", { static: true })
  informationBanner: ElementRef<HTMLTdsBannerElement>;
