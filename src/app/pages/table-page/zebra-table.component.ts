...
@Component({
  ...
  template: `
      ...
      <tds-table-body>
        ...
        <tds-table-body-row>
          ...
          <tds-body-cell
            ...
            cell-key="driver"
          ></tds-body-cell>
          <tds-body-cell cell-value="France" cell-key="country"></tds-body-cell>
          <tds-body-cell
            text-align="right"
            cell-value="8765"
            cell-key="mileage"
        ...
        <tds-table-body-row>
          ...
          <tds-body-cell
            ...
            cell-key="driver"
          ></tds-body-cell>
          <tds-body-cell cell-value="Italy" cell-key="country"></tds-body-cell>
          <tds-body-cell
            text-align="right"
            cell-value="6789"
            cell-key="mileage"
        ...
        <tds-table-body-row>
          ...
          <tds-body-cell
            ...
            cell-key="driver"
          ></tds-body-cell>
          <tds-body-cell cell-value="Spain" cell-key="country"></tds-body-cell>
          <tds-body-cell
            text-align="right"
            cell-value="9876"
            cell-key="mileage"
    ...
    <div class="tds-headline-04 tds-u-pb1 tds-u-mt3">
